...
suite('MqttMessageQueue', () => {
    ...
    let queueConfig = pip_services3_commons_nodex_1.ConfigParams.fromTuples('topic', brokerTopic, 'connection.protocol', 'mqtt', 'connection.host', brokerHost, 'connection.port', brokerPort, 'options.autosubscribe', true, 'options.serialize_envelope', true);
