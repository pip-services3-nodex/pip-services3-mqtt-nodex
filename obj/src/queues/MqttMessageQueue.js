 ...
 *     });
 */
class MqttMessageQueue extends pip_services3_messaging_nodex_1.MessageQueue {
    /**
     ...
     */
    constructor(name) {
        super(name, new pip_services3_messaging_nodex_2.MessagingCapabilities(false, true, true, true, true, false, false, false, true));
        /**
         * The dependency resolver.
         */
        this._dependencyResolver = new pip_services3_commons_nodex_4.DependencyResolver(MqttMessageQueue._defaultConfig);
        /**
         * The logger.
         */
    ...
    open(correlationId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this._connection.isOpen()) {
                throw new pip_services3_commons_nodex_2.ConnectionException(correlationId, "CONNECT_FAILED", "MQTT connection is not opened");
            }
    ...
    close(correlationId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this._connection == null) {
                throw new pip_services3_commons_nodex_3.InvalidStateException(correlationId, 'NO_CONNECTION', 'MQTT connection is missing');
            }
    ...
    toMessage(topic, data, packet) {
        ...
        if (this._serializeEnvelope) {
            ...
            message = pip_services3_messaging_nodex_3.MessageEnvelope.fromJSON(json);
        }
        else {
            message = new pip_services3_messaging_nodex_3.MessageEnvelope(null, topic, data);
...
MqttMessageQueue._defaultConfig = pip_services3_commons_nodex_1.ConfigParams.fromTuples("topic", null, "options.serialize_envelope", false, "options.autosubscribe", false, "options.retry_connect", true, "options.connect_timeout", 30000, "options.reconnect_timeout", 1000, "options.keepalive_timeout", 60000, "options.qos", 0, "options.retain", false);
